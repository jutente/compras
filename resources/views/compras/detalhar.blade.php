...
<div class="container">
    ...
    <div class="card">
            <div class="card-header">
                <a href="{{route('compras.index')}}">Compras</a> - Detalhes do Registro
            </div>
                ...
                <div class="card-body">
                    <div class="form-row card-body col-md-12">
                            <div class="form-group col-md-4 {{ $errors->has('tr_id') ? ' has-error' : '' }}">
                                    ...
                                    <input readonly type="text" class="form-control" id="tr_id" name="tr_id" value="{{$compra->tr->tr}}" readonly>
                                    @if ($errors->has('tr_id'))
                            ...
                            <div class="form-group col-md-6 {{ $errors->has('name') ? ' has-error' : '' }}">
                                    ...
                                    <input readonly type="text" class="form-control" id="name" name="name" value="{{$compra->user->name}}" readonly>
                                    @if ($errors->has('name'))
                                            <span class="help-block">
                        ...
                        <div class="form-row card-body col-md-12">
                            ...
                            <div class="form-group col-md-3 {{ $errors->has('pac') ? ' has-error' : '' }}">
                                    <label for="pac">PAC:</label>
                                       <input readonly type="text" class="form-control" id="pac" name="pac" value="{{$compra->pac}}" readonly>
                                        @if ($errors->has('pac'))
                                            <span class="help-block">
                            ...
                            <div class="form-group col-md-6 {{ $errors->has('modalidade') ? ' has-error' : '' }}">
                                    <label for="modalidade">Modalidade:</label>
                                       <input readonly type="text" class="form-control" id="modalidade" name="modalidade" value="{{$compra->modalidade}}" readonly>
                            ...
                            <div class="form-group col-md-3{{ $errors->has('cotacao') ? ' has-error' : '' }}">
                                    ...
                                    <input readonly type="date" class="form-control" id="cotacao" name="cotacao" value="{{$compra->cotacao}}" readonly>
                        ...
                        <div id="collapseOne" class="collapse" data-parent="#accordion">
                            <div class="form-row card-body col-md-12">
                                    ...
                                    <div class="form-group col-md-3{{ $errors->has('reservaorcamentariainicio') ? ' has-error' : '' }}">
                                        ...
                                        <input readonly type="date" class="form-control" id="reservaorcamentariainicio" name="reservaorcamentariainicio" value="{{$compra->reservaorcamentariainicio}}">
                                    ...
                                    <div class="form-group col-md-3{{ $errors->has('reservaorcamentariafim') ? ' has-error' : '' }}">
                                        ...
                                        <input readonly type="date" class="form-control" id="reservaorcamentariafim" name="reservaorcamentariafim"  value="{{$compra->reservaorcamentariafim}}">
                        ...
                        <div id="collapseTwo" class="collapse" data-parent="#accordion">
                                <div class="form-row card-body col-md-12">
                                        ...
                                        <div class="form-group col-md-3{{ $errors->has('mapasigma') ? ' has-error' : '' }}">
                                            ...
                                            <input readonly type="date" class="form-control" id="mapasigma" name="mapasigma" value="{{$compra->mapasigma}}">
                        ...
                        <div id="collapseThree" class="collapse" data-parent="#accordion">
                            <div class="form-row card-body col-md-12">
                                    ...
                                    <div class="form-group col-md-3{{ $errors->has('autuacao') ? ' has-error' : '' }}">
                                        ...
                                        <input readonly type="date" class="form-control" id="autuacao" name="autuacao" value="{{$compra->autuacao}}">
                            ...
                            <div id="collapse4" class="collapse" data-parent="#accordion">
                                <div class="form-row card-body col-md-12">
                                        ...
                                        <div class="form-group col-md-3{{ $errors->has('ordenadorinicio') ? ' has-error' : '' }}">
                                            ...
                                            <input readonly type="date" class="form-control" id="ordenadorinicio" name="ordenadorinicio" value="{{$compra->ordenadorinicio}}">
                                        ...
                                        <div class="form-group col-md-3{{ $errors->has('ordenadorfim') ? ' has-error' : '' }}">
                                            ...
                                            <input readonly type="date" class="form-control" id="ordenadorfim" name="ordenadorfim" value="{{$compra->ordenadorfim}}">
                            ...
                            <div id="collapse5" class="collapse" data-parent="#accordion">
                                <div class="form-row card-body col-md-12">
                                        ...
                                        <div class="form-group col-md-3{{ $errors->has('coafinicio') ? ' has-error' : '' }}">
                                            ...
                                            <input readonly type="date" class="form-control" id="coafinicio" name="coafinicio" value="{{$compra->coafinicio}}">
                                        ...
                                        <div class="form-group col-md-3{{ $errors->has('coaffim') ? ' has-error' : '' }}">
                                            ...
                                            <input readonly type="date" class="form-control" id="coaffim" name="coaffim" value="{{$compra->coaffim}}">
                        ...
                        <div id="collapse6" class="collapse" data-parent="#accordion">
                            <div class="form-row card-body col-md-12">
                                    ...
                                    <div class="form-group col-md-3{{ $errors->has('emailtrcontrato') ? ' has-error' : '' }}">
                                        ...
                                        <input readonly type="date" class="form-control" id="emailtrcontrato" name="emailtrcontrato" value="{{$compra->emailtrcontrato}}">
                        ...
                        <div id="collapse7" class="collapse" data-parent="#accordion">
                            <div class="form-row card-body col-md-12">
                                    ...
                                    <div class="form-group col-md-3{{ $errors->has('minutainicio') ? ' has-error' : '' }}">
                                        ...
                                        <input readonly type="date" class="form-control" id="minutainicio" name="minutainicio" value="{{$compra->minutainicio}}">
                                    ...
                                    <div class="form-group col-md-3{{ $errors->has('minutafim') ? ' has-error' : '' }}">
                                        ...
                                        <input readonly type="date" class="form-control" id="minutafim" name="minutafim" value="{{$compra->minutafim}}">
                        ...
                        <div id="collapse8" class="collapse" data-parent="#accordion">
                            <div class="form-row card-body col-md-12">
                                    ...
                                    <div class="form-group col-md-3{{ $errors->has('juridicoinicio') ? ' has-error' : '' }}">
                                        ...
                                        <input readonly type="date" class="form-control" id="juridicoinicio" name="juridicoinicio" value="{{$compra->juridicoinicio}}">
                                    ...
                                    <div class="form-group col-md-3{{ $errors->has('juridicofim') ? ' has-error' : '' }}">
                                        ...
                                        <input readonly type="date" class="form-control" id="juridicofim" name="juridicofim" value="{{$compra->juridicofim}}">
                        ...
                        <div id="collapse9" class="collapse" data-parent="#accordion">
                            <div class="form-row card-body col-md-12">
                                    ...
                                    <div class="form-group col-md-3{{ $errors->has('pgminicio') ? ' has-error' : '' }}">
                                        ...
                                        <input readonly type="date" class="form-control" id="pgminicio" name="pgminicio" value="{{$compra->pgminicio}}">
                                    ...
                                    <div class="form-group col-md-3{{ $errors->has('pgmfim') ? ' has-error' : '' }}">
                                        ...
                                        <input readonly type="date" class="form-control" id="pgmfim" name="pgmfim" value="{{$compra->pgmfim}}">
                        ...
                        <div id="collapse10" class="collapse" data-parent="#accordion">
                            <div class="form-row card-body col-md-12">
                                    ...
                                    <div class="form-group col-md-3{{ $errors->has('preparoratificacao') ? ' has-error' : '' }}">
                                        ...
                                        <input readonly type="date" class="form-control" id="preparoratificacao" name="preparoratificacao" value="{{$compra->preparoratificacao}}">
                                    ...
                                    <div class="form-group col-md-3{{ $errors->has('assinaturaratificacaoinicio') ? ' has-error' : '' }}">
                                        ...
                                        <input readonly type="date" class="form-control" id="assinaturaratificacaoinicio" name="assinaturaratificacaoinicio" value="{{$compra->assinaturaratificacaoinicio}}">
                                    ...
                                    <div class="form-group col-md-3{{ $errors->has('assinaturaratificacaofim') ? ' has-error' : '' }}">
                                        ...
                                        <input readonly type="date" class="form-control" id="assinaturaratificacaofim" name="assinaturaratificacaofim" value="{{$compra->assinaturaratificacaofim}}">
                                    ...
                                    <div class="form-group col-md-3{{ $errors->has('publicacaoratificacao') ? ' has-error' : '' }}">
                                        ...
                                        <input readonly type="date" class="form-control" id="publicacaoratificacao" name="publicacaoratificacao" value="{{$compra->publicacaoratificacao}}">
                        ...
                        <div id="collapse11" class="collapse" data-parent="#accordion">
                            <div class="form-row card-body col-md-12">
                                    ...
                                    <div class="form-group col-md-3{{ $errors->has('conclusao') ? ' has-error' : '' }}">
                                        ...
                                        <input readonly type="date" class="form-control" id="conclusao" name="conclusao" value="{{$compra->conclusao}}">
            ...
            <div class="card-footer">
                <div class="form-group">
                    <div class="col-md-6 col-md-offset-4">
                         <a href="{{route('compras.index')}}" class="btn btn-primary" role="button">Voltar</a>
                    </div>
                </div>
